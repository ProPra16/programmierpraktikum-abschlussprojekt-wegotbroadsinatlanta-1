package TDDT.Fensterdesigns;

import TDDT.WindowGraph.Chart;
...
public class FinalWindow{//extends Application{
   ...
   // HBox graph;
    ...
    public Scene FinalWindow(){
        ...
        public Scene getchart(double red, double green, double refac) {
